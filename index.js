...
//  Create Customers
const customers = [
    new Customer("Hina", "Raza", "Female", 25, 3001223344, accounts[0]),
    new Customer("Sara", "Ali", "Female", 20, 3301223344, accounts[1]),
    new Customer("Shahid", "Khan", "male", 35, 3451223344, accounts[2])
];
